...
function micspam {
	...
	& 'C:\Program Files\VideoLAN\VLC\vlc.exe' -I dummy --dummy-quiet --play-and-exit --one-instance --directx-volume=1.5 --aout="directx" --directx-audio-device="$id1" "$f"

	#& 'C:\Program Files\VideoLAN\VLC\vlc.exe' -I dummy --dummy-quiet --play-and-exit --one-instance -R --directx-volume=1.5 --aout="directx" --directx-audio-device="$id1" "$f"
